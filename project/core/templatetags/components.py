# COPIED FROM allauth templatetags for convenience
...
class ElementNode(template.Node):
    ...
    def render(self, context):
        ...
        template_names = []
        if layout:
            template_names.append(f"core/components/{self.element}__{layout}.html")
        template_names.append(f"core/components/{self.element}.html")
